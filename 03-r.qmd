...
3. Cree un programa (*script*) de R en RStudio (con la opción de menú *File - New File - R Script*) y escriba y ejecute el código utilizado en el capítulo anterior para generar un gráfico que muestre el [promedio de estatura de personas adultas por sexo](https://sigenr.github.io/2025-i/02-introduccion-ciencia-datos.html#promedio-de-estatura-de-personas-adultas-por-sexo-1).
...
netflix <- read.csv(
  file = "https://raw.githubusercontent.com/sigenr/2025-i/refs/heads/main/datos/netflix/netflix_titles.csv"
)
```
...
nhanes <- read.csv(
  file = "https://raw.githubusercontent.com/sigenr/2025-i/refs/heads/main/datos/nchs/nhanes.csv"
)
